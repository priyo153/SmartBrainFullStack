...
class Signin extends React.Component {
  ...
  render() {
    ...
    if (this.state.error === true)
      errormsg = (
        <h3 className="red f5">Incorrect Email or Password. Try again..</h3>
      );
        ...
        <article className="br5 pa3 ba shadow-5  b--black-10 mv4 w-100 w-50-m w-25-l mw6 center">
          <main className="pa3 black-80">
            <div className="measure pa3">
              ...
              <div>
                <input
                  className=" ph3 grow pv2 input-reset ba bw1 b--black bg-transparent pointer f4 fw8 dib"
                  type="submit"
              ...
              <div className="lh-copy mt3">
                <p
                  ...
                  className="f4 b link dim black db pointer"
                >
                  Register
                </p>
              </div>
